/*
    Spider L3S updater with Arduino Uno in WiFi switch class.
    ...
    This will upgrade a CC3000 to:
        Service Pack Version 1.26
        Release Package 1.12
...
PROGMEM prog_uchar wlan_drv_patch[8076] = {  ,
...
PROGMEM prog_uchar cRMdefaultParams[128] = { };
...
char *SendFirmwarePatch_main(unsigned long *Length)
{
    *Length = 0;
    return NULL;
}

char *SendDriverPatch_main(unsigned long *Length) 
{
    *Length = 0;
    return NULL;
}

char *SendBootloaderPatch_main(unsigned long *Length)
{
    *Length = 0;
    return NULL;
}

void CC3000_UsynchCallback_main(long lEventType, char * data, unsigned char length)
{
    (void)(lEventType);
    (void)(data);
    (void)(length);
...
int Start_CC3000(unsigned short req_patch){
    CC3000_Init();

    wlan_init(CC3000_UsynchCallback_main, SendFirmwarePatch_main, SendDriverPatch_main, SendBootloaderPatch_main, 
             ReadWlanInterruptPin, WlanInterruptEnable, WlanInterruptDisable, WriteWlanPin);

    wlan_start(req_patch);
...
unsigned char pgm_nvmem_write_patch(unsigned long ulFileId, unsigned long spLength, const uint8_t *spData)
{
...
void WritePatch(bool writeDriver) {
    ...
    if (writeDriver) {
        ...
        rval = pgm_nvmem_write_patch(NVMEM_WLAN_DRIVER_SP_FILEID, drv_length, wlan_drv_patch);
    }
    else {
        //rval = nvmem_write_patch(NVMEM_WLAN_FW_SP_FILEID, fw_length, fw_patch);
        rval = pgm_nvmem_write_patch(NVMEM_WLAN_FW_SP_FILEID, fw_length, fw_patch);
    }
...
void setup(void) {
    Serial.begin(115200);
    Serial.println(F("The Arduino CC3000 Firmware 1.26 Patcher"));
    Serial.println(F("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-"));
}
